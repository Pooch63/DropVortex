...
export default function binaryVersionCheck(binary, semverRange, options) {
    return _binaryVersionCheck.apply(this, arguments);
}
function _binaryVersionCheck() {
    _binaryVersionCheck = _async_to_generator(function(binary, semverRange, options) {
        var version, error;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                ...
                case 1:
                    ...
                    error = new Error("".concat(binary, " ").concat(version, " doesn't satisfy the version requirement of ").concat(semverRange));
